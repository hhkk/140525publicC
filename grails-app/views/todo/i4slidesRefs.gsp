...
%{--view-source:http://layout.jquery-dev.net/demos/simple.html--}%
%{--http://layout.jquery-dev.net/lib/css/layout-default-latest.css--}%
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        myLayout = $('body').layout({
            ...
            ,	south__spacing_closed:		30		// big resizer-bar when open (zero height)
            ...
            ,	west__fxSpeed_open:			3000	// 1-second animation when opening west-pane

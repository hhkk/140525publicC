...
<link type="text/css" rel="stylesheet" href="../js/hk.layout-default-latest.css" />
%{--http://layout.jquery-dev.net/lib/css/layout-default-latest.css  > /Users/hkon/sw/ustodo/110504utd/ustodo130220/web-app/js/hk.layout-default-latest.css   --}%
...
<div class="ui-layout-center">
    <a href="mailto:info@sproutedrawfoods.com?subject=Spouted Raw Foods inquiry" target="_blank">
        info@sproutedrawfoods.com</a>
    ...
    <p class="buttons">
        ...
        &nbsp;
        <button id="btnToggleState" onclick="toggleStateManagement()">Disable
    State Cookie</button>
        &nbsp;

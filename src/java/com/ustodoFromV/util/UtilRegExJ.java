...
//	}
  ...
  public static String escapeMongoRequiredRegExChars(String s)
  {
//      s = s.replaceAll("\\*", "\\\\*");
//      //s = s.replaceAll("\\*", '\\\u002a');
//      s = s.replaceAll("\\?", "\\\\?");
...
//      s = s.replaceAll("\\/", "\\\\/");
	...
	public static boolean fileLineRawHasProperDateOnly  (String flrs)
	{
		...
		return UtilRegExJ.matches ("^\\d\\d\\d\\d-\\d\\d-\\d\\d.*", flrs);
	...
	public static boolean fileLineRawHasProperDateAndTime (String flrs)
	{
       ...
       return UtilRegExJ.matches ("^\\d\\d\\d\\d-\\d\\d-\\d\\d \\d\\d:\\d\\d:\\d\\d.*", flrs);

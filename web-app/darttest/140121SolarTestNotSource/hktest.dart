...
void main() {
  ...
  try {
    ...
    var jsonObjEmployees = JSON.decode(sJsonEmployees);
    ...
    window.alert ("DART: JSON.runtimeType.toString():" + JSON.runtimeType.toString());
    List parsedList = JSON.decode(listAsJson);
    // no work window.alert ("List.runtimeType.toString():" + List.runtimeType.toString());
    window.alert ("DART:parsedList[0]:" + parsedList[0]); // Dart
    window.alert ("DART:parsedList[1]:" + parsedList[1]); // Dart

    // no work window.alert ("List.runtimeType.toString():" + List.runtimeType.toString());
    var parsedList2 = JSON.decode(sJsonEmployees);

...
["html_common", "dart:html_common", , P, {
  ...
  _convertDartToNative_PrepareForStructuredClone_walk: {
    "": "Closure:11;findSlot_5,readSlot_6,writeSlot_7",
    call$1: function(e) {
...
["solar", "solar.dart", , Q, {
  "": "",
  main: [function() {
    var canvas, e, stackTrace, t1, exception;
    try {
      ...
      canvas = document.querySelector("#idCanvasPlanets");
      t1 = new Q.SolarSystem(canvas, null, null, null, null);
      P.scheduleMicrotask(t1.get$start(t1));
    } catch (exception) {
      t1 = H.unwrapException(exception);
      e = t1;
      stackTrace = new H._StackTrace(exception, null);
      t1 = C.JSString_methods.$add("DART:10.5 in catch ERRORHBK", J.toString$0(stackTrace));
      window.alert("DART:" + t1);
      t1 = C.JSString_methods.$add("DART:10.6 in catch ERRORHBK", e.getClass$0());
      window.alert("DART:" + t1);
    }
  ...
  main_closure: {
    ...
    call$1: function($event) {
      var myObj, listAsJson, sSend_data3Js, e, stackTrace, e0, stackTrace0, t1, lhmJson, parsedListdotEmployees, t2, exception;
      try {
        t1 = J.get$data$x($event);
        P.print("in UtilJson.convertJsonStringToLinkedHashMap");
        lhmJson = C.C_JsonCodec.decode$1(t1);
        t1 = J.getInterceptor$asx(lhmJson);
        parsedListdotEmployees = t1.$index(lhmJson, "employees");
        t2 = J.getInterceptor(parsedListdotEmployees);
        if (typeof parsedListdotEmployees === "object" && parsedListdotEmployees !== null && (parsedListdotEmployees.constructor === Array || !!t2.$isList))
          P.print("yes parsedListdotEmployees is List");
        else
          P.print("no parsedListdotEmployees is List");
        t1 = t1.get$runtimeType(lhmJson);
        P.print(C.JSString_methods.$add("lhmJson.runtimeType.toString():", t1.toString$0(t1)));
        myObj = lhmJson;
        if (!J.$eq(J.toString$0(J.$index$asx(myObj, "typehk")), "js2dart")) {
          window.alert("DART:" + "not js2dart, returning");
          return;
        }
        window.alert("DART:" + "dart will process: js2dart, returning");
        listAsJson = "[\"Dart\",1.0]";
        C.C_JsonCodec.decode$1(listAsJson);
        try {
          J.$indexSet$ax(myObj, "typehkwas", J.$index$asx(myObj, "typehk"));
          J.$indexSet$ax(myObj, "typehk", "Json.Type_FromDart2Js");
          sSend_data3Js = C.C_JsonCodec.encode$1(myObj);
          C.Window_methods.postMessage$2(window, sSend_data3Js, "*");
        } catch (exception) {
          t1 = H.unwrapException(exception);
          e = t1;
          stackTrace = new H._StackTrace(exception, null);
          t1 = C.JSString_methods.$add(C.JSString_methods.$add("DART:error in DART:2.1:", J.toString$0(e)) + ":\r\n", J.toString$0(stackTrace));
          window.alert("DART:" + t1);
        }
        ...
        t1 = H.unwrapException(exception);
        e0 = t1;
        stackTrace0 = new H._StackTrace(exception, null);
        t1 = C.JSString_methods.$add(C.JSString_methods.$add("DART:error in DART:0.6991  ", J.toString$0(e0)) + ":", J.toString$0(stackTrace0));
        window.alert("DART:" + t1);
      }
  ...
  SolarSystem: {
    "": "Object;canvas,width,height,sun,renderTime",
    start$0: [function(_) {
      var t1, t2, rect, mercury, venus, earth, mars, jupiter, io, europa, ganymede, callisto;
      t1 = this.canvas;
      t2 = t1.parentElement;
      rect = H.setRuntimeTypeInfo(new P.Rectangle(t2.clientLeft, t2.clientTop, t2.clientWidth, t2.clientHeight), [null]);
      t2 = rect.width;
      this.width = t2;
      this.height = rect.height;
      J.set$width$x(t1, t2);
      mercury = Q.PlanetaryBody$(this, "orange", 0.382, 0.387, 0.241);
      venus = Q.PlanetaryBody$(this, "green", 0.949, 0.723, 0.615);
      earth = Q.PlanetaryBody$(this, "#33f", 1, 1, 1);
      earth.planets.push(Q.PlanetaryBody$(this, "gray", 0.2, 0.14, 0.075));
      mars = Q.PlanetaryBody$(this, "red", 0.532, 1.524, 1.88);
      jupiter = Q.PlanetaryBody$(this, "gray", 4, 5.203, 11.86);
      io = Q.PlanetaryBody$(this, "gray", 0.36000000000000004, 0.2806666666666667, 0.024569444444444442);
      europa = Q.PlanetaryBody$(this, "gray", 0.31000000000000005, 0.4473333333333333, 0.049319444444444444);
      ganymede = Q.PlanetaryBody$(this, "gray", 0.53, 0.7133333333333333, 0.09936111111111111);
      callisto = Q.PlanetaryBody$(this, "gray", 0.48, 1.2546666666666666, 0.23179166666666665);
      t2 = jupiter.planets;
      t2.push(io);
      t2.push(europa);
      t2.push(ganymede);
      t2.push(callisto);
      t2 = Q.PlanetaryBody$(this, "#ff2", 14, 0, 0);
      t1 = t2.planets;
      t1.push(mercury);
      t1.push(venus);
      t1.push(earth);
    ...
    draw$1: [function(_) {
      ...
      if (typeof t3 !== "number")
        return t3.$div();
      t1.draw$2(context, H.setRuntimeTypeInfo(new P.Point(t2 / 2, t3 / 2), [null]));
      t3 = window;
      t2 = this.get$draw();
      C.Window_methods._ensureRequestAnimationFrame$0(t3);
      C.Window_methods._requestAnimationFrame$1(t3, W._wrapZone(t2));
    }, "call$1", "get$draw", 2, 0, 22],
    addAsteroidBelt$2: function(body, count) {
      var i, radius, t1, t2, t3, t4;
      for (i = 0; i < count; ++i) {
        radius = 2.06 + C.C__JSRandom.nextDouble$0() * 1.21;
        t1 = 0.1 * C.C__JSRandom.nextDouble$0();
        t2 = radius * 2;
        t3 = [];
        t3.$builtinTypeInfo = [Q.PlanetaryBody];
        t3 = new Q.PlanetaryBody("#777", t2, this, t1, radius, null, t3);
        t1 = Math.log(t1 + 1);
        t4 = this.width;
        if (typeof t4 !== "number")
          return t4.$div();
        t3.bodySize = t1 * (t4 / 100);
        t3.orbitRadius = radius * (t4 / 10);
        t3.orbitSpeed = t2 === 0 ? 0 : 1 / (2880 * t2);
        body.planets.push(t3);
      }
    }
  },
  PlanetaryBody: {
    "": "Object;color,orbitPeriod,solarSystem,bodySize,orbitRadius,orbitSpeed,planets",
    draw$2: function(context, p) {
      var pos = this.calculatePos$1(p);
      this.drawSelf$2(context, pos);
      this.drawChildren$2(context, pos);
    },
    drawSelf$2: function(context, p) {
      var t1, t2, t3, t4;
      t1 = p.x;
      t2 = this.bodySize;
      if (typeof t1 !== "number")
      ...
      t4 = this.color;
      context.fillStyle = t4;
      context.strokeStyle = t4;
      if (t2 >= 2) {
      ...
      context.beginPath();
      context.arc(t1, t3, this.bodySize, 0, 6.283185307179586, false);
      context.fill();
      context.closePath();
    ...
    drawChildren$2: function(context, p) {
      var t1;
      for (t1 = this.planets, t1 = H.setRuntimeTypeInfo(new H.ListIterator(t1, t1.length, 0, null), [H.getTypeArgumentByIndex(t1, 0)]); t1.moveNext$0();)
        t1._current.draw$2(context, p);
    },
    calculatePos$1: function(p) {
      var t1, t2, angle, t3, t4, t5, t6;
      t1 = this.orbitSpeed;
      if (t1 === 0)
        return p;
      t2 = this.solarSystem.renderTime;
      if (typeof t2 !== "number")
        return t2.$mul();
      if (typeof t1 !== "number")
        return H.iae(t1);
      ...
      if (typeof t6 !== "number")
        return H.iae(t6);
      return H.setRuntimeTypeInfo(new P.Point(t1 * t2 + t3, t4 * t5 + t6), [null]);
    },
    PlanetaryBody$5: function(solarSystem, color, bodySize, orbitRadius, orbitPeriod) {
      var t1, t2;
      t1 = this.bodySize;
      t1 = Math.log(t1 + 1);
      t2 = this.solarSystem.width;
      if (typeof t2 !== "number")
        return t2.$div();
      this.bodySize = t1 * (t2 / 100);
      this.orbitRadius = this.orbitRadius * (t2 / 10);
      t2 = this.orbitPeriod;
      this.orbitSpeed = t2 === 0 ? 0 : 1 / (2880 * t2);
    },
    static: {PlanetaryBody$: function(solarSystem, color, bodySize, orbitRadius, orbitPeriod) {
        var t1 = new Q.PlanetaryBody(color, orbitPeriod, solarSystem, bodySize, orbitRadius, null, H.setRuntimeTypeInfo([], [Q.PlanetaryBody]));
        t1.PlanetaryBody$5(solarSystem, color, bodySize, orbitRadius, orbitPeriod);
        return t1;
      }}
  }
},
...
function dart_precompiled($collectedClasses) {
  ...
  function SolarSystem(canvas, width, height, sun, renderTime) {
    this.canvas = canvas;
    this.width = width;
    this.height = height;
    this.sun = sun;
  ...
  SolarSystem.builtin$cls = "SolarSystem";
  if (!"name" in SolarSystem)
    SolarSystem.name = "SolarSystem";
  $desc = $collectedClasses.SolarSystem;
  if ($desc instanceof Array)
    $desc = $desc[1];
  SolarSystem.prototype = $desc;
  function PlanetaryBody(color, orbitPeriod, solarSystem, bodySize, orbitRadius, orbitSpeed, planets) {
    this.color = color;

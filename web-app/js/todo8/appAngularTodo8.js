...
var appAngularModule = angular.module( "Todo8AngularModule", [] ); // goes on body or html tag
// <html lang="en" ng-app="Todo3AngularModule">

//eg pairs with
//    <body ng-controller="TodoCtrl" ng-init="init()">
//    <body ng-controller="Todo8AngularModule" ng-init="init()">
...
appAngularModule.controller(
    "AppAngularTodo8Ctrl",
    function( $scope ) {

        //alert("hbk in AppAngularTodo8Ctrl angular init1");
